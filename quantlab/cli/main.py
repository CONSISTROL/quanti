...
def run_optimization(config):
    ...
    # 优化
    from quantlab.optimizer import optimize_strategy
...
def run_single_stock(stock_code, config, strat_override=None):
    ...
    # 运行个股回测
    from quantlab.trading_engine import backtest_single_stock, print_trade_summary
...
def main():
    ...
    try:
        ...
        # 阶段3: 波段交易回测
        # ================================================================
        from quantlab.trading_engine import run_swing_backtest, print_trade_summary, generate_equity_chart
        from quantlab.indicator_cache import precompute_all_indicators
